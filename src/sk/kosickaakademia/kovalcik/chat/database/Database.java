package sk.kosickaakademia.kovalcik.chat.database;

import sk.kosickaakademia.kovalcik.chat.entity.Messages;
import sk.kosickaakademia.kovalcik.chat.entity.Users;
import sk.kosickaakademia.kovalcik.chat.util.Util;
...
//------------------------------------------------------------------------------------------------------
        ...
        public void changePassword(String loginUser, String password,String newPassword ) {

            String jq = "UPDATE user" + "SET password = ?" + "WHERE login = ? AND password =?";
